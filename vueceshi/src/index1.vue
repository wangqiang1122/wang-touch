...
<template>
  <div>
      ...
      <div class="vaildate-v1" @click="clinpint">
        <div class="vaildate-v2" ref="vaildate" :style="{'z-index':zH}" v-show="Show">
          <input type="tel"
                 @blur="outinput"
                 @keyup="outin"
                 v-focus
        ...
        <span :key="index"  v-for="(i,index) in num" v-text="codeArray[i-1]?codeArray[i-1]:''" ref="spanlist" ></span>
      </div>
